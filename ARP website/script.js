...
const showContent = (section) => {
  ...
  if (content) {
    const contentData = {
      autopark: `<img src="https://via.placeholder.com/600" alt="Autopark"><div class="text-overlay"><h2>300+ COOL CARS</h2><p>DO YOU LIKE TO DRIVE? CHOOSE A CAR FOR YOURSELF, A NIGHT DRIFTER OR A DASHING DRAG RACER?</p></div>`,
      residents: `<img src="https://via.placeholder.com/600" alt="Residents"><div class="text-overlay"><h2>EVENTS</h2><p>YOU WILL DEFINITELY NOT BE BORED! 15 DIFFERENT EVENTS WITH COOL REWARDS.</p></div>`,
      gangster: `<img src="https://via.placeholder.com/600" alt="Gangster"><div class="text-overlay"><h2>BECOME A GANGSTER OR CREATE YOUR OWN CRIMINAL FAMILY??</h2><p>GET INTO ONE OF THE 5 CRIMINAL GANGS AND DO DANGEROUS BUSINESS.</p></div>`,
      business: `<img src="https://via.placeholder.com/600" alt="Business"><div class="text-overlay"><h2>FROM RAGS TO RICHES</h2><p>MAKE THIS STATE PAY YOU MONEY, IT'S ALL IN YOUR HANDS</p></div>`,
      default: "",
    };
...
const handleSectionToggle = () => {
  ...
  const stateOrganizationSection = document.querySelector(".state-organization-section");
  const roleplayBiographiesSection = document.querySelector(".roleplay-biographies-section");
  ...
  const viewStateOrganizationLinks = document.querySelectorAll(".view-state-organization");
  const viewRoleplayBiographiesLinks = document.querySelectorAll(".view-roleplay-biographies");
  const backToGameSectionLinks = document.querySelectorAll(".back-to-game-section");
